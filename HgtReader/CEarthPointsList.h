...
#ifndef CEARTHPOINTSLIST_H
#define CEARTHPOINTSLIST_H
...
public:
    ...
    bool operator<(const CEarthPoint &other) const {
...
class CEarthPointsList
{
public:
    CEarthPointsList();

    QList<CEarthPoint> earthPoints;

    void load();
    void save();
    int addAndSort(QString name, double earthPointLon, double earthPointLat, double earthPointAlt, double earthPointX, double earthPointY, double earthPointZ);
};

#endif // CEARTHPOINTSLIST_H
